  ...
  return (
    <div>
      ...
      <main className="bg-gray-900 mx-auto ">
        <section className="hero__bg-pattern bg-fixed bg-no-repeat h-screen bg-gradient-to-br from-gray-800 to-gray-900 pb-64 shadow-inner">
          <header className="max-w-7xl mx-auto py-4 lg:py-8 px-4 xl:px-0">
            <div className="flex justify-center items-center">
              <img className="block w-32 md:w-72" src="logos/GCCC-logo.svg" />
            </div>
          </header>
          <div className="max-w-7xl 2xl:max-w-screen-2xl flex flex-col md:flex-row items-center justify-between mx-auto text-white pt-24 pb-12 px-4 xl:px-0">
        ...
        <section className="relative border-t border-gray-800 bg-gray-900 py-24">
          <div className="max-w-6xl 2xl:max-w-7xl mx-auto">
            <h2 className="relative mx-auto pt-8 before:block before:absolute before:w-24 before:h-2 before:bg-indigo-500 before:left-1/2 before:-translate-x-1/2 before:top-0 max-w-4xl text-secondary-200 text-center font-black text-2xl lg:text-5xl leading-snug">
              Product Showcase
            </h2>
            <div className="mt-16">
              <img
            ...
            <div className="relative mt-32 before:block before:absolute before:w-1 before:h-24 before:bg-indigo-500 before:left-1/2 before:-translate-x-1/2 before:-top-24 bg-indigo-500 p-1 rounded-2xl">
              <img
            ...
            <div className="grid grid-cols-12 gap-x-20 bg-gradient-to-br from-gray-700 to-bg-gray-700 p-10 rounded-b-2xl mx-12 border border-t-0 border-gray-800">
              <p className="col-span-8 text-xl leading-normal text-white">
              ...
              <div className="col-span-4">
                <div className="bg-white rounded-2xl shadow-xl p-6 -mt-20 z-10 relative border-4 border-indigo-500">
                  <img
                    className="object-contain rounded-2xl mx-auto w-48"
        ...
        <section className="relative border-t border-gray-800 bg-gray-900 py-24">
          <div className="grid grid-cols-12 gap-24 max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <h2 className="col-span-6 relative pt-8 before:block before:absolute before:w-20 before:h-2 before:bg-indigo-500 before:left-0 before:top-0 max-w-4xl text-secondary-200 font-black text-2xl lg:text-5xl lg:leading-tight">
              Accelerate Digital Transformation for Governments
            </h2>
            <div className="col-span-6 text-white text-xl leading-normal">
              <p>
              ...
              <p className="mt-8">
                GCCC creates a well trained group of students who are proficient
        ...
        <section className="relative border-t border-gray-800 bg-gray-800">
          <div className="grid grid-cols-12 gap-8 max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <div className="col-span-4">
              <div className="sticky top-0 py-24">
                <h2 className="col-span-4 relative pt-8 before:block before:absolute before:w-20 before:h-2 before:bg-indigo-500 before:left-0 before:top-0 max-w-4xl text-secondary-200 font-black text-2xl lg:text-5xl lg:leading-tight">
                  An initiative supported by
                </h2>
              </div>
            </div>
            <div className="col-span-8 text-white text-xl leading-normal py-24">
        ...
        <section className="relative border-t border-gray-700 bg-gray-900 py-24">
          <div className="grid grid-cols-12 gap-8 max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <div className="sticky top-0 col-span-4">
              <h2 className="relative pt-8 before:block before:absolute before:w-20 before:h-2 before:bg-indigo-500 before:left-0 before:top-0 max-w-4xl text-secondary-200 font-black text-2xl lg:text-5xl lg:leading-tight">
                Supported By:
              </h2>
            </div>
            <div className="col-span-8 text-white text-xl leading-normal">
        ...
        <section className="relative border-t border-gray-700 bg-gray-900">
          <div className="grid grid-cols-12 gap-8 max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <div className="col-span-4">
              <div className="sticky top-0 py-24">
                <h2 className="relative pt-8 before:block before:absolute before:w-20 before:h-2 before:bg-indigo-500 before:left-0 before:top-0 max-w-4xl text-secondary-200 font-black text-2xl lg:text-5xl lg:leading-tight">
                  GCCC Fellows - Class of 2021
                </h2>
              </div>
            </div>
            <div className="col-span-8 text-white text-xl leading-normal py-24">
              ...
              <div className="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-3 sm:gap-4 md:gap-8 lg:gap-16 lg:gap-y-20 pt-12 lg:pt-16">
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Abhinandan.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Apurva.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Amith-Kumar.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Arpan.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Divya-Garg.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Karan.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Khavin.png"
                      alt="Pupilfirst"
                    />
                  </div>
                  <p className="text-xl font-semibold pt-3">Khavin Shankar G</p>
                  <p className="text-base pt-2 text-gray-300">SRM University</p>
                </div>
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Peeyush-Goyal.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Pradipta-Ghoshal.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Samyukyha.png"
                      alt="Pupilfirst"
                    />
                  </div>
                  <p className="text-xl font-semibold pt-3">
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Sandra.png"
                      alt="Pupilfirst"
                    />
                  </div>
                  <p className="text-xl font-semibold pt-3">
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Shailesh.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Shri-Hari-L.png"
                      alt="Pupilfirst"
                    />
                  </div>
                ...
                <div className="text-center">
                  <div className="w-48 h-48 mx-auto rounded-full border-2 border-indigo-500 bg-gray-600">
                    <img
                      className="object-contain rounded-full"
                      src="people/GCCC-fellows-2021/Swapnil.png"
                      alt="Pupilfirst"
                    />
                  </div>
        ...
        <section className="relative border-t border-gray-800 bg-gray-900">
          <div className="grid grid-cols-12 gap-8 max-w-7xl 2xl:max-w-screen-2xl mx-auto">
            <div className="col-span-4">
              <div className="sticky top-0 py-24">
                <h2 className="col-span-4 relative pt-8 before:block before:absolute before:w-20 before:h-2 before:bg-indigo-500 before:left-0 before:top-0 max-w-4xl text-secondary-200 font-black text-2xl lg:text-5xl lg:leading-tight">
        ...
        <div className="relative">
          <div className="sticky top-0 bg-gray-900 text-white z-10">
            <div className="grid grid-cols-2 rounded-full max-w-7xl mx-auto">
              <div className="col-span-1 text-center programme-link relative z-0 ">
                <a
                  className="block p-4 rounded-l-full border border-gray-800 bg-indigo-900 text-indigo-300 text-lg lg:text-xl font-medium bg-opacity-20 focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
                  href="#programme-1"
                >
                  GCCC Software Engineering Fellowship Programme
                </a>
              </div>
              <div className="col-span-1 text-center programme-link ">
                <a
                  className="block p-4 -ml-px rounded-r-full border border-gray-800 text-lg lg:text-xl font-medium focus:z-10 focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
                  href="#programme-2"
                >
                  GCCC Field Ops Fellowship Programme
                </a>
              </div>
            </div>
          </div>
          <section id="programme-1" className="relative bg-gray-900">
            <div className="max-w-7xl 2xl:max-w-8xl mx-auto">
              <div className="pt-10 lg:pt-20">
                <p className="text-lg uppercase text-gray-400 font-semibold tracking-wide">
                  Programme 1
                </p>
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-12 2xl:gap-5 px-0 pb-10 lg:pb-20">
                <div className="lg:col-span-6">
                  <div className="space-y-6 md:space-y-16 md:pr-12 pt-4 md:pt-16">
                    <div>
                      <h3 className="text-xl lg:text-3xl text-green-100 font-bold">
                        About
                      </h3>
                      <p className="pt-4 text-lg lg:text-xl lg:leading-normal font-medium text-secondary-50">
                        GCCC Software Engineering Fellowship is a national
                    ...
                    <div>
                      ...
                      <ul className="pt-4 ml-6 text-lg lg:text-xl lg:leading-normal font-medium space-y-8 text-secondary-50">
                ...
                <div className="lg:col-span-6 border-l border-t border-gray-800 rounded-l-2xl mt-20">
                  <div className="sticky top-0">
                    <div className="grid grid-cols-2 gap-x-8 gap-y-12 p-16 tracking-wide">
                      <div className="col-span-1 text-white">
                        <p className="text-lg uppercase text-gray-400 font-semibold">
                          Level:
                        </p>
                        <p className="text-3xl font-bold pt-1">Basic</p>
                      </div>
                      <div className="col-span-1 text-white">
                        <p className="text-lg uppercase text-gray-400 font-semibold">
                          Duration:
                        </p>
                        <p className="text-3xl font-bold pt-1">13 Weeks</p>
                      </div>
                      <div className="col-span-1 text-white">
                        <p className="text-lg uppercase text-gray-400 font-semibold">
                          Certification:
                        </p>
                        <p className="text-3xl font-bold pt-1">Yes</p>
                      </div>
                      <div className="col-span-1 text-white">
                        <p className="text-lg uppercase text-gray-400 font-semibold">
                          Fee:
                        </p>
                        <p className="text-3xl font-bold pt-1">Sponsored</p>
                      </div>
                      <div className="col-span-1 text-white">
                        <p className="text-lg uppercase text-gray-400 font-semibold">
                          Remote Internship:
                        </p>
                        <p className="text-3xl font-bold pt-1">6 months</p>
                      </div>
                    </div>
                    <div className="px-4 lg:px-16 pb-10">
                      <button className="bg-green-600 rounded-full w-full text-xl text-white font-semibold px-6 py-4 border border-transparent shadow-sm hover:bg-green-700 focus:outline-none focus:bg-green-500 focus:ring-2 focus:ring-offset-2 focus:ring-green-700">
                        Apply Now
                      </button>
                    </div>
                  </div>
          ...
          <section
            id="programme-2"
            className="relative border-t border-gray-800 bg-gray-900"
          >
            <div className="max-w-7xl 2xl:max-w-8xl mx-auto">
              <div className="pt-10 lg:pt-20">
                <p className="text-lg uppercase text-gray-400 font-semibold tracking-wide">
              ...
              <div className="lg:grid lg:grid-cols-12 lg:gap-12 2xl:gap-5 px-0 pb-10 lg:pb-20">
                <div className="lg:col-span-6">
                  <div className="space-y-6 md:space-y-16 md:pr-12 pt-4 md:pt-16">
                    <div>
                      ...
                      <p className="pt-4 text-lg lg:text-xl lg:leading-normal font-medium text-secondary-50">
                        GCCC Field Ops Fellowship is a national programme to
                    ...
                    <div>
                      ...
                      <p>After completion of the programme students will</p>
                      <ul className="pt-4 ml-6 text-lg lg:text-xl lg:leading-normal font-medium space-y-8 text-secondary-50">
                        <li className="relative before:absolute before:w-3 before:h-3 before:bg-indigo-500 before:rounded-full before:left-0 before:top-2 pl-8">
                ...
                <div className="lg:col-span-6 border-l border-t border-gray-800 rounded-l-2xl mt-20">
                  <div className="sticky top-0">
                    ...
                    <div className="px-4 lg:px-16 pb-10">
                      <button className="bg-indigo-500 rounded-full w-full text-xl text-white font-semibold px-6 py-4 border border-transparent shadow-sm hover:bg-indigo-700 focus:outline-none focus:bg-indigo-500 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">
                        Apply Now
                      </button>
                    </div>
                  </div>
